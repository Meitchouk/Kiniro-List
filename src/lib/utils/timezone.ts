...
export function getTimezoneInfo(tz: string): TimezoneInfo {
  try {
    ...
    const offsetFormatted = offsetHours % 1 === 0 
...
export function getAllTimezones(): string[] {
  try {
    ...
    return [
      ...
      'America/Anchorage', 'America/Phoenix', 'America/Mexico_City', 'America/Bogota',
      'America/Lima', 'America/Santiago', 'America/Buenos_Aires', 'America/Sao_Paulo',
      'America/Caracas', 'America/Toronto', 'America/Vancouver', 'America/Edmonton',
      'America/Guatemala', 'America/Costa_Rica', 'America/Panama',
      ...
      'Europe/Moscow', 'Europe/Istanbul', 'Europe/Kiev', 'Europe/Lisbon',
      ...
      'Asia/Jerusalem', 'Asia/Beirut', 'Asia/Kuwait', 'Asia/Karachi',
...
export function groupTimezones(timezones: string[]): Record<string, TimezoneInfo[]> {
  ...
  const orderedRegions = ['UTC', 'America', 'Europe', 'Asia', 'Australia', 'Pacific', 'Africa', 'Atlantic', 'Indian', 'Antarctica'];
